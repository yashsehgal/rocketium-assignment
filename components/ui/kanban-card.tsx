...
export interface KanbanCardProps extends React.HTMLAttributes<HTMLDivElement>, KanbanCardType {
  index: number;
}

export const KanbanCard = forwardRef<HTMLDivElement, KanbanCardProps>(
  ({ className, taskTitle, teamName, ticketID, tags, assignees, index, ...args }, ref) => {
    return <motion.div
      initial={{
        y: (index + 1) * 12,
        opacity: 0,
